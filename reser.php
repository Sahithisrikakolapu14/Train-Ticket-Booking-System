...
<body>
    <div class="wrap">
        ...
        <div class="span12 well">
            <div class="display" style="margin-top:0px;height:30px;">
                <form method="post" action="process_booking.php"> <table class="table" style="border-style:ridge;">
                        <col width="99">
                        <col width="50">
                        <col width="50">
                        <col width="80">
    ...
    <input type="radio" name="selct" value="1A" onclick="return false;" <?php if ($selected_class == '1A') echo 'checked'; ?>> 
</td>

<td style="border-top:0px;"> 
    <input type="radio" name="selct" value="2A" onclick="return false;" <?php if ($selected_class == '2A') echo 'checked'; ?>> 
</td>

<td style="border-top:0px;"> 
    <input type="radio" name="selct" value="3A" onclick="return false;" <?php if ($selected_class == '3A') echo 'checked'; ?>> 
</td>

<td style="border-top:0px;"> 
    <input type="radio" name="selct" value="SL" onclick="return false;" <?php if ($selected_class == 'SL') echo 'checked'; ?>> 
</td>
